...
public class DbConnectionStrings {
	...
	/**
	 * The method returns a DbConnectionStrings object. This object can then be
	 * used to access database settings
	 * 
	...
	/**
	 * This method is used when getting a database name. It is needed for a
	 * database connection in the DBConnector class
	 * 
	...
	/**
	 * This method is used when getting a database access port. It is needed for
	 * a database connection in the DBConnector class
	 * 
	 ...
	 * 
	 * @param dbPwd
	 *            new password, which should be used to access the database
	 */
